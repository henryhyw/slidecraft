...
def build_generation_preflight(
    ...
    lines.append("- Exact slide content, semantic design, visual references, and slide-selected project visuals are prepared for the external image-generation request.")
    lines.append("- Project visuals retain their canonical files, content-preservation rules, and intrinsic aspect ratios for later reconstruction.")
